...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .antMatchers(HttpMethod.POST, "/auth/image/**").permitAll()
                .antMatchers(HttpMethod.POST, "/auth/phone/mail/description/**").permitAll()
                .antMatchers(HttpMethod.GET, "/auth/image/**").permitAll()
                .and()
                .authorizeRequests()
                ...
                .antMatchers(HttpMethod.GET, "/auth/userinfo/**").hasAnyRole("ADMIN", "USER")
                ...
                .antMatchers(HttpMethod.DELETE, "/types/**").hasRole("ADMIN")
