...
public class AuthController {
    ...
    @PostMapping("{id}/{phone}/{mail}/{description}")
    public ResponseEntity<?> setUserByUsername(@PathVariable("id") Long id, @PathVariable("phone") String phone, @PathVariable("mail") String mail, @PathVariable("description") String description) {
        authService.setUserByUsername(id,phone,mail,description);
        return new ResponseEntity<Void>(HttpStatus.OK);
    }
}
